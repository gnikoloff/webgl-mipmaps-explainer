import{t as oe,c as U,o as ne,f as S,l as w,m as W,p as ae,s as H,i as ie,r as se}from"./vendor.7d86c8f9.js";const ue=function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))a(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const s of n.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&a(s)}).observe(document,{childList:!0,subtree:!0});function i(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerpolicy&&(n.referrerPolicy=r.referrerpolicy),r.crossorigin==="use-credentials"?n.credentials="include":r.crossorigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function a(r){if(r.ep)return;r.ep=!0;const n=i(r);fetch(r.href,n)}};ue();const ce=(t,o,i)=>Math.min(Math.max(t,o),i),C=(t,o,i,a,r)=>{const n=(t-o)*(r-a)/(i-o)+a;return ce(n,a,r)},Y=(t,o,i)=>{const a=t.createShader(o);if(t.shaderSource(a,i),t.compileShader(a),t.getShaderParameter(a,t.COMPILE_STATUS))return a;const r=`
    Error in ${o===t.VERTEX_SHADER?"Vertex":"Fragment"} shader:
    ${t.getShaderInfoLog(a)}
  `;throw t.deleteShader(a),new Error(r)},k=(t,o,i)=>{const a=Y(t,t.VERTEX_SHADER,o),r=Y(t,t.FRAGMENT_SHADER,i),n=t.createProgram();if(t.attachShader(n,a),t.attachShader(n,r),t.linkProgram(n),t.detachShader(n,a),t.deleteShader(a),t.detachShader(n,r),t.deleteShader(r),t.getProgramParameter(n,t.LINK_STATUS))return n;const s=new Error(`Error linking program: ${t.getProgramInfoLog(n)}`);throw t.deleteProgram(n),s},fe=innerWidth,le=innerHeight,me=["#f39c12","#2980b9","#27ae60","#d35400","#7f8c8d","#bdc3c7","#1abc9c","red","blue","green"],de=(t,o,i)=>{const a=document.createElement("canvas"),r=a.getContext("2d");a.width=t*devicePixelRatio,a.height=o*devicePixelRatio,r.fillStyle="#000",r.fillRect(0,0,t,o);const n=t/innerWidth,s=o/innerHeight,P=4*n,x=800,T=innerHeight<innerWidth?x*n:x*s;r.strokeStyle="#fff",r.lineWidth=P;const E=5,A=5,f=t/E,l=o/A;r.strokeRect(0,0,t,o),r.textAlign="center",r.textBaseline="middle",r.font=`${T}px sans-serif`,r.fillStyle=me[i];for(let m=1;m<E;m++){const p=m*f;r.beginPath(),r.moveTo(p,0),r.lineTo(p,o),r.stroke()}for(let m=1;m<A;m++){const p=m*l;r.beginPath(),r.moveTo(0,p),r.lineTo(t,p),r.stroke()}return r.fillText(i,t/2,o/2),a},$=(t,o=fe,i=le)=>{o=Math.min(o,t.MAX_TEXTURE_SIZE),i=Math.min(i,t.MAX_TEXTURE_SIZE);const a=t.createTexture();t.bindTexture(t.TEXTURE_2D,a);let r=o,n=i,s=0;for(;r>=2||n>=2;){r=o*Math.pow(.5,s),n=i*Math.pow(.5,s),r=r<1?Math.ceil(r):r,n=n<1?Math.ceil(n):n;const _=de(r,n,s);t.texImage2D(t.TEXTURE_2D,s,t.RGB,r,n,0,t.RGB,t.UNSIGNED_BYTE,_),s++}return t.texParameterf(t.TEXTURE_2D,t.anisotropyExtension.TEXTURE_MAX_ANISOTROPY_EXT,t.maxAnisotropy),t.bindTexture(t.TEXTURE_2D,null),a},Ee=innerWidth,xe=innerHeight,G=(t,o=Ee,i=xe)=>{o=Math.min(o,t.MAX_TEXTURE_SIZE),i=Math.min(i,t.MAX_TEXTURE_SIZE);const a=document.createElement("canvas"),r=a.getContext("2d");a.width=o,a.height=i,r.fillStyle="#000",r.fillRect(0,0,o,i);const n=4,s=o/innerWidth,_=n*s;r.strokeStyle="#fff",r.lineWidth=_;const P=5,x=5,T=o/P,E=i/x;r.strokeRect(0,0,o,i);for(let f=1;f<P;f++){const l=f*T;r.beginPath(),r.moveTo(l,0),r.lineTo(l,i),r.stroke()}for(let f=1;f<x;f++){const l=f*E;r.beginPath(),r.moveTo(0,l),r.lineTo(o,l),r.stroke()}const A=t.createTexture();return t.bindTexture(t.TEXTURE_2D,A),t.texImage2D(t.TEXTURE_2D,0,t.RGB,o,i,0,t.RGB,t.UNSIGNED_BYTE,a),t.texParameterf(t.TEXTURE_2D,t.anisotropyExtension.TEXTURE_MAX_ANISOTROPY_EXT,t.maxAnisotropy),t.generateMipmap(t.TEXTURE_2D),t.bindTexture(t.TEXTURE_2D,null),A};var j=`#version 300 es
